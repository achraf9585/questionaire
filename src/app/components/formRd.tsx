    ...
    <div className="container mx-auto py-28  ">
      <Card className="w-full max-w-4xl mx-auto ">
        <CardHeader>
          ...
          <CardDescription>
            Please provide information about your enterprise&apos;s R&D
            activities
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="reportingUnit">
                  Are you reporting data for your enterprise, group
                  (consolidated) or any other statistical unit?
                </Label>
                <Select
                  name="reportingUnit"
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="providedFundsForRD">
                  Did your company provide funds to other parties (including
                  firms it is affiliated with), to carry out substantive R&D
                  work?
                </Label>
                <RadioGroup
          ...
          {step === 7 && (
            <div className="space-y-4">
              ...
              <div>
                <Label>
                  Your company&apos;s capital expenditure on assets intended to
                  be used for R&D
                </Label>
                <div className="space-y-2 mt-2">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      type="number"
                      value={
                        formData.rdCapitalExpenditure.machineryAndEquipment
                      }
                      onChange={(e) =>
                        handleNestedInputChange(
                          "rdCapitalExpenditure",
          ...
          {step === 9 && (
            <div className="space-y-4">
              <div>
                <Label>
                  Please report your company&apos;s intramural R&D expenditure
                  in 2023 for the following key technologies:
                </Label>
                <div className="space-y-2 mt-2">
                  <div>
                ...
                <div className="space-y-2 mt-2">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      type="number"
                      value={
                        formData.rdFieldOfResearch.engineeringAndTechnology
                      }
                      onChange={(e) =>
                        handleNestedInputChange(
                          "rdFieldOfResearch",
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      type="number"
                      value={
                        formData.rdFieldOfResearch.medicalAndHealthSciences
                      }
                      onChange={(e) =>
                        handleNestedInputChange(
                          "rdFieldOfResearch",
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Input
                        type="number"
                        value={
                          formData.sourcesOfFunds.nonAffiliatedCompanies.ksa
                        }
                      />
                    </TableCell>
                    <TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Input
                        type="number"
                        value={
                          formData.sourcesOfFunds.foreignGovernments.abroad
                        }
                      />
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Input
                        type="number"
                        value={
                          formData.rdPersonnel.internal.supportStaff.female
                        }
                      />
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Input
                        type="number"
                        value={
                          formData.rdPersonnel.external.supportStaff.female
                        }
                      />
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Input
                        type="number"
                        value={
                          formData.rdPersonnelEducation.researchers.phd.male
                        }
                      />
                    </TableCell>
                    <TableCell>
                      ...
                      <Input
                        ...
                        value={
                          formData.rdPersonnelEducation
                            .techniciansAndSupportStaff.phd.male
                        }
                      />
                    </TableCell>
                    <TableCell>
                      <Input
                        ...
                        value={
                          formData.rdPersonnelEducation
                            .techniciansAndSupportStaff.phd.female
                        }
                      />
                    </TableCell>
                  </TableRow>
